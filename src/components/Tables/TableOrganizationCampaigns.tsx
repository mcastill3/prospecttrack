...
const TableOrganizationCampaigns = async ({ companyId }: { companyId: string }) => {
  // Obtener campañas en las que el jugador está involucrado
  const campaigns = await prisma.campaign.findMany({
    where: {
      contacts: {
        some: {
          companyId: companyId, // Filtrar campañas con contactos de esta empresa
        },
      },
    },
    orderBy: {
    ...
    include: {
      contacts: {
        include: {
          company: true, // Incluir la empresa a la que pertenece el contacto
        },
      },
    },
  });
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className="flex items-center justify-between mb-6 border-b pb-4">
        <h1 className="text-2xl font-semibold text-gray-800">Organization Campaigns</h1>
...
export default TableOrganizationCampaigns;