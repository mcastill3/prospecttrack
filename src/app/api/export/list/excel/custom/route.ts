// /app/api/export/list/excel/customfilter/route.ts
...
export async function POST(req: Request) {
  ...
  const rows = contacts.map((contact) => ({
    ...
    JobTitle: formatJobTitle(contact.jobTitle),
    Email: contact.email,
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "Filtered List");
  ...
  return new Response(arrayBuffer, {
    ...
    headers: {
      ...
      "Content-Disposition": 'attachment; filename="custom_filtered_list.xlsx"',
    },
  });
}
