// /app/api/export/list/excel/type/route.ts
...
export async function POST(req: Request) {
  ...
  return new Response(arrayBuffer, {
    ...
    headers: {
      ...
      "Content-Disposition": 'attachment; filename="prospection_list_by_type.xlsx"',
    },
  });
}
